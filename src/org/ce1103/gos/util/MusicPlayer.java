...
public class MusicPlayer {
	...
	public static final Media backgroundMusicFile = new Media("file://gos/view/graphicResources/Music.mp3");
	public static final MediaPlayer backgroundMusicPlayer = new MediaPlayer(backgroundMusicFile);
	
	public static final Media pauseSoundFile = new Media("file://gos/view/graphicResources/PauseSound.wav");
	public static final MediaPlayer pauseSoundPlayer = new MediaPlayer(pauseSoundFile);
	
	public static final Media shootSoundFile = new Media("file://gos/view/graphicResources/ShootSound.wav");
	public static final MediaPlayer shootSoundPlayer = new MediaPlayer(shootSoundFile);
	
	public static final Media enemyKilledSound = new Media("file://gos/view/graphicResources/EnemyKilledSound.wav");
